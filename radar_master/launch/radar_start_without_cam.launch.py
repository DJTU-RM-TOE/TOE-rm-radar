...
def generate_launch_description():
    ...
    from common import get_map_2D_node,get_serial_node,get_radar_ui_container
    ...
    # 图像标定进程 #
    ##############
    hik_camera_node_1 = get_camera_node('none_camera', 'none_camera::NoneCameraNode', "camera_1_node")
    hik_camera_node_2 = get_camera_node('none_camera', 'none_camera::NoneCameraNode', "camera_2_node")
